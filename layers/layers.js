...
lyr_Schneeschuhwanderwege_1.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Abwicklung': 'Abwicklung', 'AOrt': 'Ausgangs Ort', 'AuspraegR': 'AuspraegR', 'BeschreibR': 'Beschreibung', 'Change_Dt': 'Change_Dt', 'GueltigJ': 'GueltigJ', 'HoeheAbR': 'HoeheAbR', 'HoeheAufR': 'HoeheAufR', 'HoeheMaxR': 'HoeheMaxR', 'HoeheMinR': 'HoeheMinR', 'KonditionR': 'Konditionelle Schwierigkeit', 'LaengeR': 'Länge [m]', 'LVRoute_ID': 'LVRoute_ID', 'ReStR': 'ReStR', 'Richtung': 'Signalisationsrichtung', 'Routenart': 'Routenart', 'TechnikR': 'TechnikR', 'NameR': 'Name', 'NrR_ID': 'RoutenID FA LV', 'Typ_TR': 'Typ_TR', 'ZeitStZiR': 'Zeit Start - Ziel [min]', 'ZeitZiStR': 'Zeit Ziel - Start [min]', 'ZOrt': 'Zielort', 'NichtPubFhg': 'NichtPubFhg', 'UnsEtpZiel': 'UnsEtpZiel', 'NrR': 'Routennummer', 'LvArt': 'LvArt', 'Traeger': 'Trägerschaft', 'TraegerBem': 'TraegerBem', 'IsCHM': 'IsCHM', 'SHAPE_Length': 'SHAPE_Length', });
...
lyr_Winterwanderwege_3.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Abwicklung': 'Abwicklung', 'AOrt': 'Ausgangs Ort', 'AuspraegR': 'AuspraegR', 'BeschreibR': 'Beschreibung', 'Change_Dt': 'Change_Dt', 'GueltigJ': 'GueltigJ', 'HoeheAbR': 'HoeheAbR', 'HoeheAufR': 'HoeheAufR', 'HoeheMaxR': 'HoeheMaxR', 'HoeheMinR': 'HoeheMinR', 'KonditionR': 'Konditionelle Schwierigkeit', 'LaengeR': 'Länge [m]', 'LVRoute_ID': 'LVRoute_ID', 'ReStR': 'ReStR', 'Richtung': 'Signalisationsrichtung', 'Routenart': 'Routenart', 'TechnikR': 'TechnikR', 'NameR': 'Name', 'NrR_ID': 'RoutenID FA LV', 'Typ_TR': 'Typ_TR', 'ZeitStZiR': 'Zeit Start - Ziel [min]', 'ZeitZiStR': 'Zeit Ziel - Start [min]', 'ZOrt': 'Zielort', 'NichtPubFhg': 'NichtPubFhg', 'UnsEtpZiel': 'UnsEtpZiel', 'NrR': 'Routennummer', 'LvArt': 'LvArt', 'Traeger': 'Trägerschaft', 'TraegerBem': 'TraegerBem', 'IsCHM': 'IsCHM', 'SHAPE_Length': 'SHAPE_Length', });
