...
lyr_Schneeschuhwanderwege_1.set('fieldLabels', {'OBJECTID': 'no label', 'Abwicklung': 'inline label - visible with data', 'AOrt': 'hidden field', 'AuspraegR': 'hidden field', 'BeschreibR': 'inline label - visible with data', 'Change_Dt': 'hidden field', 'GueltigJ': 'hidden field', 'HoeheAbR': 'hidden field', 'HoeheAufR': 'hidden field', 'HoeheMaxR': 'hidden field', 'HoeheMinR': 'hidden field', 'KonditionR': 'inline label - visible with data', 'LaengeR': 'inline label - visible with data', 'LVRoute_ID': 'hidden field', 'ReStR': 'hidden field', 'Richtung': 'inline label - visible with data', 'Routenart': 'inline label - visible with data', 'TechnikR': 'inline label - visible with data', 'NameR': 'inline label - visible with data', 'NrR_ID': 'hidden field', 'Typ_TR': 'hidden field', 'ZeitStZiR': 'inline label - visible with data', 'ZeitZiStR': 'inline label - visible with data', 'ZOrt': 'hidden field', 'NichtPubFhg': 'no label', 'UnsEtpZiel': 'hidden field', 'NrR': 'inline label - visible with data', 'LvArt': 'hidden field', 'Traeger': 'inline label - visible with data', 'TraegerBem': 'hidden field', 'IsCHM': 'hidden field', 'SHAPE_Length': 'hidden field', });
...
lyr_Winterwanderwege_3.set('fieldLabels', {'OBJECTID': 'no label', 'Abwicklung': 'inline label - visible with data', 'AOrt': 'hidden field', 'AuspraegR': 'hidden field', 'BeschreibR': 'inline label - visible with data', 'Change_Dt': 'hidden field', 'GueltigJ': 'hidden field', 'HoeheAbR': 'hidden field', 'HoeheAufR': 'hidden field', 'HoeheMaxR': 'hidden field', 'HoeheMinR': 'hidden field', 'KonditionR': 'inline label - visible with data', 'LaengeR': 'inline label - visible with data', 'LVRoute_ID': 'hidden field', 'ReStR': 'hidden field', 'Richtung': 'inline label - visible with data', 'Routenart': 'inline label - visible with data', 'TechnikR': 'hidden field', 'NameR': 'inline label - visible with data', 'NrR_ID': 'hidden field', 'Typ_TR': 'hidden field', 'ZeitStZiR': 'inline label - visible with data', 'ZeitZiStR': 'inline label - visible with data', 'ZOrt': 'hidden field', 'NichtPubFhg': 'no label', 'UnsEtpZiel': 'hidden field', 'NrR': 'inline label - visible with data', 'LvArt': 'hidden field', 'Traeger': 'inline label - visible with data', 'TraegerBem': 'hidden field', 'IsCHM': 'hidden field', 'SHAPE_Length': 'hidden field', });
