...
lyr_LandeskarteWinter_0.setVisible(true);lyr_Schneeschuhwanderwege_1.setVisible(true);lyr_WinterWeg_2.setVisible(true);lyr_Winterwanderwege_3.setVisible(true);
var layersList = [lyr_LandeskarteWinter_0,lyr_Schneeschuhwanderwege_1,lyr_WinterWeg_2,lyr_Winterwanderwege_3];
lyr_Schneeschuhwanderwege_1.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Abwicklung': 'Abwicklung', 'AOrt': 'AOrt', 'AuspraegR': 'AuspraegR', 'BeschreibR': 'BeschreibR', 'Change_Dt': 'Change_Dt', 'GueltigJ': 'GueltigJ', 'HoeheAbR': 'HoeheAbR', 'HoeheAufR': 'HoeheAufR', 'HoeheMaxR': 'HoeheMaxR', 'HoeheMinR': 'HoeheMinR', 'KonditionR': 'KonditionR', 'LaengeR': 'LaengeR', 'LVRoute_ID': 'LVRoute_ID', 'ReStR': 'ReStR', 'Richtung': 'Richtung', 'Routenart': 'Routenart', 'TechnikR': 'TechnikR', 'NameR': 'NameR', 'NrR_ID': 'NrR_ID', 'Typ_TR': 'Typ_TR', 'ZeitStZiR': 'ZeitStZiR', 'ZeitZiStR': 'ZeitZiStR', 'ZOrt': 'ZOrt', 'NichtPubFhg': 'NichtPubFhg', 'UnsEtpZiel': 'UnsEtpZiel', 'NrR': 'NrR', 'LvArt': 'LvArt', 'Traeger': 'Traeger', 'TraegerBem': 'TraegerBem', 'IsCHM': 'IsCHM', 'SHAPE_Length': 'SHAPE_Length', });
...
lyr_Winterwanderwege_3.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Abwicklung': 'Abwicklung', 'AOrt': 'AOrt', 'AuspraegR': 'AuspraegR', 'BeschreibR': 'BeschreibR', 'Change_Dt': 'Change_Dt', 'GueltigJ': 'GueltigJ', 'HoeheAbR': 'HoeheAbR', 'HoeheAufR': 'HoeheAufR', 'HoeheMaxR': 'HoeheMaxR', 'HoeheMinR': 'HoeheMinR', 'KonditionR': 'KonditionR', 'LaengeR': 'LaengeR', 'LVRoute_ID': 'LVRoute_ID', 'ReStR': 'ReStR', 'Richtung': 'Richtung', 'Routenart': 'Routenart', 'TechnikR': 'TechnikR', 'NameR': 'NameR', 'NrR_ID': 'NrR_ID', 'Typ_TR': 'Typ_TR', 'ZeitStZiR': 'ZeitStZiR', 'ZeitZiStR': 'ZeitZiStR', 'ZOrt': 'ZOrt', 'NichtPubFhg': 'NichtPubFhg', 'UnsEtpZiel': 'UnsEtpZiel', 'NrR': 'NrR', 'LvArt': 'LvArt', 'Traeger': 'Traeger', 'TraegerBem': 'TraegerBem', 'IsCHM': 'IsCHM', 'SHAPE_Length': 'SHAPE_Length', });
...
lyr_Schneeschuhwanderwege_1.set('fieldLabels', {'OBJECTID': 'no label', 'Abwicklung': 'inline label - visible with data', 'AOrt': 'inline label - visible with data', 'AuspraegR': 'hidden field', 'BeschreibR': 'inline label - visible with data', 'Change_Dt': 'hidden field', 'GueltigJ': 'hidden field', 'HoeheAbR': 'hidden field', 'HoeheAufR': 'hidden field', 'HoeheMaxR': 'hidden field', 'HoeheMinR': 'hidden field', 'KonditionR': 'inline label - visible with data', 'LaengeR': 'inline label - visible with data', 'LVRoute_ID': 'hidden field', 'ReStR': 'hidden field', 'Richtung': 'inline label - visible with data', 'Routenart': 'inline label - visible with data', 'TechnikR': 'hidden field', 'NameR': 'inline label - visible with data', 'NrR_ID': 'inline label - visible with data', 'Typ_TR': 'hidden field', 'ZeitStZiR': 'inline label - visible with data', 'ZeitZiStR': 'inline label - visible with data', 'ZOrt': 'inline label - visible with data', 'NichtPubFhg': 'no label', 'UnsEtpZiel': 'hidden field', 'NrR': 'inline label - visible with data', 'LvArt': 'hidden field', 'Traeger': 'inline label - visible with data', 'TraegerBem': 'hidden field', 'IsCHM': 'hidden field', 'SHAPE_Length': 'no label', });
lyr_WinterWeg_2.set('fieldLabels', {'OBJECTID': 'no label', 'BelagTLM': 'no label', 'Bverb': 'no label', 'BverbE': 'no label', 'BverbQ': 'no label', 'Change_Dt': 'no label', 'LVWeg_ID': 'no label', 'ReStWeg': 'no label', 'TLM_ID': 'no label', 'VerkehrM': 'no label', 'Zustand': 'no label', 'GeigenE': 'no label', 'IsGEigen': 'no label', 'Netzhier': 'no label', 'ZustTx': 'no label', 'IsWinter': 'no label', 'ObjektArt': 'no label', 'Kunstbaute': 'no label', 'WegKat': 'no label', 'SHAPE_Length': 'no label', });
lyr_Winterwanderwege_3.set('fieldLabels', {'OBJECTID': 'no label', 'Abwicklung': 'inline label - visible with data', 'AOrt': 'inline label - visible with data', 'AuspraegR': 'hidden field', 'BeschreibR': 'inline label - visible with data', 'Change_Dt': 'hidden field', 'GueltigJ': 'hidden field', 'HoeheAbR': 'hidden field', 'HoeheAufR': 'hidden field', 'HoeheMaxR': 'hidden field', 'HoeheMinR': 'hidden field', 'KonditionR': 'inline label - visible with data', 'LaengeR': 'inline label - visible with data', 'LVRoute_ID': 'hidden field', 'ReStR': 'hidden field', 'Richtung': 'inline label - visible with data', 'Routenart': 'inline label - visible with data', 'TechnikR': 'hidden field', 'NameR': 'inline label - visible with data', 'NrR_ID': 'inline label - visible with data', 'Typ_TR': 'hidden field', 'ZeitStZiR': 'inline label - visible with data', 'ZeitZiStR': 'inline label - visible with data', 'ZOrt': 'inline label - visible with data', 'NichtPubFhg': 'no label', 'UnsEtpZiel': 'hidden field', 'NrR': 'inline label - visible with data', 'LvArt': 'hidden field', 'Traeger': 'inline label - visible with data', 'TraegerBem': 'hidden field', 'IsCHM': 'hidden field', 'SHAPE_Length': 'no label', });
